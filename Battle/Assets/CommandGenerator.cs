        ...
        switch (command)
        {
            case "たたかう":
               EnemySelect();
                break;
            case "にげる":
                BattleDirector.GetComponent<BattleDirector>().AddLog(player.player.NameGettter() + "は逃げ出そうとした。");
                player.Escape();
                ClearWindow();
                break;
            case "ぼうぎょ":
                BattleDirector.GetComponent<BattleDirector>().AddLog(player.player.NameGettter() + "は防御を固めた。");
                player.Defence();
                ClearWindow();
                break;
            case "どうぐ":
